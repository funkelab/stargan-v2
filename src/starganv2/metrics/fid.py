...
class InceptionV3(nn.Module):
    ...
    def forward(self, x):
        # Stack x three times in the channel dimension to make it compatible with inception_v3
...
def calculate_fid_given_paths(paths, img_size=256, batch_size=50):
    ...
    loaders = [get_eval_loader(path, img_size, batch_size, imagenet_normalize=False) for path in paths]
